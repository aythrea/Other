...
**++ Battalion Detachment +5CP (Imperium - Space Wolves) [89 PL, 1,477pts] ++**
...
**+ Fast Attack [25 PL, 363pts] +**

&nbsp;

**Skyclaws [17 PL, 225pts]**

**Categories:** *Faction: Adeptus Astartes, Faction: Imperium, Faction: Space Wolves, Infantry, Blood Claw, Jump Pack, Fly, Skyclaws, Fast Attack*

**Abilities:** *Beserk Charge, Headstrong, Jump Pack Assault*
...
**Abilities:** *Jump Pack Assault*, **Unit:** *Skyclaw*, **Weapon:** *Bolt pistol, Chainsword, Frag grenade, Krak grenade*

**Skyclaw Pack Leader [15pts]:** Bolt pistol, Chainsword

**Categories:** *Fly, Jump Pack*

**Abilities:** *Jump Pack Assault*, **Unit:** *Skyclaw Pack Leader*, **Weapon:** *Bolt pistol, Chainsword, Frag grenade, Krak grenade*
...
**Swiftclaws [8 PL, 138pts]**

**Categories:** *Faction: Adeptus Astartes, Faction: Imperium, Faction: Space Wolves, Biker, Blood Claw, Swiftclaws, Fast Attack*

**Abilities:** *Beserk Charge, Headstrong*


**Swiftclaw [23pts]:** Bolt pistol

**Unit:** *Swiftclaw*, **Weapon:** *Bolt pistol, Frag grenade, Krak grenade*


**Bike [2pts]:** Twin boltgun [2pts]
...
**Swiftclaw Pack Leader [23pts]:** Bolt pistol

**Unit:** *Swiftclaw Pack Leader*, **Weapon:** *Bolt pistol, Frag grenade, Krak grenade*
...
**Turbo-boost:** Description:When this model Advances add 6" to its Move characteristic for that Movement phase instead of rolling a dice.|

**Swiftclaw:** M:14"|WS:3+|BS:4+|S:4|T:5|W:2|A:1|Ld:7|Save:3+|

**Swiftclaw Pack Leader:** M:14"|WS:3+|BS:4+|S:4|T:5|W:2|A:2|Ld:7|Save:3+|
...
**Twin boltgun:** Range:24"|Type:Rapid Fire 2|S:4|AP:0|D:1|Abilities:-|
...
**Categories:** *Faction: Adeptus Astartes, Dedicated Transport, Faction: Imperium, Rhino, Transport, Vehicle*

**Abilities:** *Explodes, Self-repair, Smoke Launchers*, **Stat Damage - M/BS/A:** *Rhino (1), Rhino (2), Rhino (3)*, **Transport:** *Transport*, **Unit:** *Rhino*, **Weapon:** *Storm bolter*

**Profiles:**

**Explodes:** Description:If this model is reduced to 0 wounds, roll a D6 before removing it from the battlefield and before any embarked models disembark. On a 6 it explodes, and each unit within 6" suffers D3 mortal wounds.|

**Self-repair:** Description:Roll a D6 at the start of each of your turns; on a 6, this model regains one lost wound.|

**Smoke Launchers:** Description:Once per game, instead of shooting any weapons in the Shooting phase, the vehicle can use its Smoke Launchers; until your next Shooting phase your opponent must subtract 1 from all hit rolls for ranged weapons that target this vehicle.|BRB

**Rhino (1):** Remaining W:6-10+|Movement:12"|BS:3+|Attacks:3|

**Rhino (2):** Remaining W:3-5|Movement:6"|BS:4+|Attacks:D3|

**Rhino (3):** Remaining W:1-2|Movement:3"|BS:5+|Attacks:1|

**Transport:** Capacity:This model can transport 10 SPACE WOLVES INFANTRY models. It cannot transport JUMP PACK, TERMINATOR, PRIMARIS, or WULFEN  models.|

**Rhino:** M:*|WS:6+|BS:*|S:6|T:7|W:10|A:*|Ld:8|Save:3+|
